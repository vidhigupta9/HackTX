                        ...
                        <div className="px-4  mx-auto max-w-7xl sm:px-6">
                            <div className="flex items-center justify-between py-3 border-b-2 md:justify-start md:space-x-8">
                                <div className="flex justify-start lg:w-0 lg:flex-1">
                                    <Link to='/' className="w-auto text-5xl text-white no-underline cursor-pointer font-carattere">ARMuseum</Link>
                                </div>
                                ...
                                <Popover.Group as="nav" className="hidden md:flex md:space-x-0 lg:space-x-3">
                                    ...
                                    <div className='pl-2 mt-1 cursor-pointer nav-links' onClick={signOut}>
                                ...
                                <div className="bg-gray-800 divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
                                    <div className="px-5 pt-3 pb-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <div className="flex justify-start lg:w-0 lg:flex-1">
                                                    <Link to='/' className="w-auto h-8 text-5xl text-white no-underline font-carattere">ARMuseum</Link>
                                                </div>
                                            </div>
                                            <div className="-mr-2">
                                        ...
                                        <div className="mt-6">
                                            <nav className="grid text-white font-sourceSerifPro gap-y-8">Learning chemistry made easy...</nav>
                                        </div>
                                    </div>
                                    <div className="px-5 py-6 space-y-6">
                                        ...
                                        <div className='grid cursor-pointer place-items-center' onClick={signOut}>
                                            <img src={LogoutIcon} height="40" width="40" className="text-white" alt="logout" aria-hidden="true" />
                                        </div>
                                    </div>
